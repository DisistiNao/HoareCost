...
happyExpList = Happy_Data_Array.listArray (0,52) ([4032,16,1,0,61440,32771,8192,4032,1024,252,63,61440,3,16384,4096,1024,0,32,8,64512,16128,4096,1024,0,0,0
	])
...
action_2 (5) = happyShift action_14
...
action_21 (13) = happyReduce_7
action_21 (14) = happyReduce_7
...
happyNewToken action sts stk
	...
	case tk of {
	Token _ TEOF -> action 14 14 tk (HappyState action) sts stk;
